...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 10 juil. 2020 à 18:03
...
CREATE TABLE `class_joined` (
  ...
  `nom_classe` int(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `etudiant` (`ID_MEMBRE`, `CNE`, `APOGEE`, `FILIERE`) VALUES
(37, 'R78985611003', '17502287', 'sma'),
(38, 'R12478963', '17512369', 'smp'),
(44, 'R49899743', '14725836', 'sma'),
(45, '77998', '17506779', 'mi'),
(47, 'oa', 'oa', 'sma'),
(48, 'R13345696', '17508245', 'smi');
...
CREATE TABLE `membre` (
  ...
  `etat` enum('I','C') NOT NULL DEFAULT 'I',        /*etat du compte a la creation, en cas de problème */
...
(37, 'knya', 'smya', '2000-08-14', 'aa@hotmail.fr', 'aa', '0602187455', 'Egypte', 'BE146699', 'hada_test_2000', 's', 'C', 'profile.png'),
(38, 'ali', 'zawa', '2003-02-17', 'ali', 'zawa', '00212447798', 'Guinee', 'Bk556472', 'a_zawa', 's', 'C', 'profile.png'),
(44, 'meme', 'anana', '2001-08-09', 'onana@hotmail.com', 'onana', '000000000', 'germany', 'AZAZAZAZAA', 'sgqrg', 's', 'C', 'profile.png'),
(45, 'Youssef', 'Zaidoune', '1999-09-11', 'zaidouney@gmail.com', 'aa', '0606060', 'mrc', '7779797', 'y.zdn', 's', 'C', 'profile.png'),
(47, 'oa', 'oa', '2000-11-04', 'oa@gmail.com', 'oa', 'oa', 'oa', 'oa', 'zpzzp', 's', 'C', 'profile.png'),
...
(50, 'zak', 'fahim', '0000-00-00', 'zak-fahim@univ.com', 'zed', '+212612082344', '', 'Bk683733', 'zed', 's', 'C', 'profile.png'),
...
(59, 'jamal', 'eddine', '2015-02-11', 'jamal@eddine.com', 'jj', '+212612082344', 'maroc', 'Bk683733', 'jamaleddine', 'p', 'C', 'profile.png');
...
--
ALTER TABLE `class_joined`
  MODIFY `ID_TABLE` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `membre`
  MODIFY `ID_MEMBRE` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
