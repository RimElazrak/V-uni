 ...
 while ($cl = $res_classe->fetch_assoc()){
   ...
   /* $displaypub= "SELECT * FROM publication WHERE visibilite='all'; ";//test
    ...
    //    publications de la filiere choisie après avoir récupéré l'id à partir de la page Filières
      //$viewPublication="";  
      $displaypub="SELECT * from publication where  id_filiere='$filiere_id' order by DATE_PUB DESC " ;// voir enum dans la base de donnees
                        ...
                        <div class='row'>
                          <div class=\"card\">
                            <div class=\"card-body\">
                              ...
                              <form method=\"POST\" style = \"margin-left: 7%\" action='publier.php\?id_f=  $filiere_id'>
                                <input type=\"hidden\" name=\"t$token\" value=\"$idpb\">
                                <div class=\"add-items d-flex\">
                                  <input type=\"text\" required name=\"$token\" placeholder=\"Commenter\"class=\"form-control todo-list-input\" style=\"height:50px;width:450px;word-break:break-word; overflow: auto; border: 0; padding-bottom: 5px\">
                                  <button class=\"btn btn-primary mr-2\" type=\"submit\" value=\"$token\" name=\"commenter\"><i class=\"fa fa-paper-plane \" ></i></button>
                              ...
                              <button onclick='togglecomments($token,b$token)' id = $token type='button' class='btn btn-inverse-warning btn-fw'>
        ...
        <div class="content-wrapper">
          <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="filieres.php">Filières</a></li>
              ...
              <div class="card-body">
                <div class="media">
                  ...
                  <div class="media-body">
                    ...
                    <div class="form-group">
                    <?php
                      echo "<form method='POST' action='publier.php\?id_f=  $filiere_id' >"
                    ?>
                          <br>
                        <div class="form-group">
