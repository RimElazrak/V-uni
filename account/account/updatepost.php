                              ...
                              <div class="media">
                                ...
                                <div class="media-body">
                                  ...
                                  <div class="dropdown-menu" x-placement="top-start" style="position: absolute; transform: translate3d(0px, -2px, 0px); top: 0px; left: 0px; will-change: transform;">
                                      <option value="all" class="dropdown-item" <?php if ($visiblePour=='all') echo "selected";?>>Tout le monde</option>
                                      <option value="classe" class="dropdown-item" <?php if ($visiblePour=='classe') echo "selected";?>>Classe</option>
                                      <option value="fil" class="dropdown-item" <?php if ($visiblePour=='fil') echo "selected";?>>Filière</option>
                                  </select>
                                  ...
                                  <input type="text" name="titre" class="form-control" value="<?php echo $pubTitle; ?>" id="exampleInputCity1">
                                  <label for="exampleTextarea1" style="padding-top: 8px">Publication</label>
                                    <textarea name="contenu" class="form-control" id="exampleTextarea1" rows="4"><?php echo $pubContent; ?></textarea>
