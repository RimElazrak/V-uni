...
<head>
  ...
  <title>V-UNI private Classeroom</title>
  <!-- plugins:css -->
...
<body class="boxed-layout">
  <div class="container-scroller">
    ...
    <?php include ('nav/nav_classe.php') ?>
        ...
        <div class="content-wrapper">
          <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="filieres.php">Classroom</a></li>
                <li class="breadcrumb-item active" aria-current="page"><?php echo $cl; ?></li>
              </ol>
            </nav>
          </div>
            ...
            <div class="col-12">
              <div class="card card-statistics">
                <div class="card-body">
                  ...
                  <h2><i class="fa fa-window-restore"> </i> <?php echo $cl; ?></h2><br>
                  <h5><?php echo $sem; ?></h5>
                  <h5><?php echo $description; ?></h5><br>
